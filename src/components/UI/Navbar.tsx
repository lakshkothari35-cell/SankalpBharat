      ...
      >
        <div className="flex items-center gap-4 md:gap-12 pointer-events-auto">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <div className="text-sm md:text-lg font-serif font-bold tracking-[0.2em] uppercase leading-none text-beige text-glow">
        ...
        <div className="flex items-center gap-3 md:gap-4 pointer-events-auto">
          ...
          <button 
            ...
            className="p-3 bg-white/5 border border-gold/10 rounded-xl hover:bg-gold/10 transition-all text-gold group"
          >
          ...
          <button 
            ...
            className="p-3 bg-gold text-[#0c0805] rounded-xl hover:bg-white hover:text-maroon transition-all shadow-[0_0_20px_rgba(212,175,55,0.3)]"
          >
